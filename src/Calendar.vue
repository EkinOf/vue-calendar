<template>
  <div class="comp-full-calendar">
    ...
    <div class="full-calendar-body">
      <div class="weeks">
        <strong class="week" v-for="(dayIndex, key) in 7" :key="key">{{ (dayIndex - 1) | localeWeekDay(firstDay, locale) }}</strong>
      </div>
      <div class="dates" ref="dates">
        <div class="dates-bg">
          <div class="week-row" v-for="(week, key) in currentDates" :key="key">
            <div class="day-cell" v-for="(day, subKey) in week"
        ...
        <div class="dates-events">
          <div class="events-week" v-for="(week, key) in currentDates" :key="key">
            <div class="events-day" v-for="(day, subKey) in week" track-by="$index"
              :key="subKey"
              :class="{'today' : day.isToday,
              'not-cur-month' : !day.isCurMonth}" @click.stop="dayClick(day.date, $event)">
              <p class="day-number">{{day.monthDay}}</p>
              <div class="event-box">
                <event-card :event="event" :date="day.date" :firstDay="firstDay" v-for="(event, subSubKey) in day.events" :key="subSubKey" v-show="event.cellIndex <= eventLimit" @click="eventClick">
        ...
        <div class="more-events" v-show="showMore"
          ...
          <div class="more-body">
            <ul class="body-list">
              <li v-for="(event, key) in selectDay.events"
                :key="key"
